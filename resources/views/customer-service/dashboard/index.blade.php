...
<div class="main-content">
                                ...
                                <table class="table table-condensed table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        {{-- <tr>
                                            <td>No Handphone:</td>
                                            <td>
                                                {{Auth::user()->customer_service->no_hp}}
                                            </td>
                                        </tr> --}}
                                        <tr>
                                            <td>Status:</td>
                                            <td><span class="label label-sm label-info">Customer Service</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="core-box">
                                        ...
                                        <div class="content">
                                            Pada halaman ini, anda dapat melihat laporan penerbitan  surat keterangan
                                            perusahan. 
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="core-box">
                                        ...
                                        <div class="content">
                                            Pada halaman ini, anda dapat melihat laporan penerbitan surat rekomendasi
    ...
    <script src="assets/admin/plugins/jquery.pulsate/jquery.pulsate.min.js"></script>
