<!-- start: SIDEBAR -->
<div class="main-navigation navbar-collapse collapse" style="padding-top: 0.75rem !important" >
    ...
    <ul class="main-navigation-menu">
        ...
        @php
            $segment = ['kbli', 'data-tampilan', 'pengawas', 'petugas', 'pegawai', 'customer-service', 'pemohon', 'dokumen'];
        @endphp
