                    ...
                    <div class="panel-body">
                        <form method="post" action="#" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <select class="form-control" id="country" name="status-tahap-1" onchange="cekStatus(this)">
                                        <option value="">&nbsp;</option>
                            ...
                            <div id="lengkap" class="form-group">
                                <label class="col-sm-3 control-label">
                                    Petugas <span class="symbol required"></span>
                                </label>
                                <div class="col-sm-7">
                                    <select class="form-control" id="country" name="petugas">
                                        <option value="">&nbsp;</option>
                            ...
                            <div id="tidak-lengkap" class="form-group">
                                <label class="col-sm-3 control-label">
...
<script>
    ...
    function cekStatus(element) {
        showDiv('lengkap', element);
        showDiv('tidak-lengkap', element);
    }
