                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a class="btn btn-xs btn-success"
                                                                ...
                                                                {{-- @elseif ($item->status_penerbitan == 'diterbitkan')
                                                                        <a class="btn btn-xs btn-primary" href="{{url('get-notif', $item->angkutan->perusahaan->nama_perusahaan)}}"><i
                                                        ...
                                                        <div id="naik{{$item->id}}" class="modal fade" tabindex="-1"
                                                            ...
                                                            <form
                                                                action="{{url('/konfirmasi-birokrasi-surat-angkutan', $item->id)}}">
                                                                @csrf
                                                        ...
                                                        <div id="konfirmasi-penerbitan{{$item->id}}" class="modal fade"
                                                            ...
                                                            <form
                                                                action="{{url('/konfirmasi-penerbitan-surat-angkutan', $item->id)}}">
                                                                @csrf
                                                                <div class="modal-footer">
                                                                    <button type="button" data-dismiss="modal"
                                                                        class="btn btn-default">
