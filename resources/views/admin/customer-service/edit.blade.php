            ...
            <div class="col-sm-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form method="post" action="{{ route('customer-service.update', $cs->id) }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="nama" value="{{$cs->nama}}" placeholder="Nama Lengkap"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="no_hp" value="{{$cs->no_hp}}" placeholder="Nomor Handphone"
