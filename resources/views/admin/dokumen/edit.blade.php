            ...
            <div class="col-sm-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form method="post" action="{{ route('dokumen.update', $data->id) }}" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <p>Dokumen yang telah terunggah sebelumnya <a href="{{$data->file_template}}">dokumen</a></p>
                                </div>
                            </div>
                            <div class="form-group">
