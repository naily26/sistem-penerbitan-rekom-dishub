                    ...
                    <div class="panel-body">
                        <form method="post" action="{{ route('kbli.store') }}" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="kode" placeholder="Kode KBLI" id="form-field-1"
                                        class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="keterangan" placeholder="Keterangan" id="form-field-1"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select class="select2-container form-control search-select" id="select-kategori" name="kategori" required>
                                        ...
                                        <option value="angkutan-penumpang-umum-dalam-trayek">Angkutan Penumpang Umum
                                            Dalam Trayek</option>
                                        <option value="angkutan-penumpang-umum-tidak-dalam-trayek">Angkutan Penumpang
                                            Umum Tidak Dalam Trayek</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
